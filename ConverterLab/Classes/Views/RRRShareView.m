...
//    for (NSInteger i=0; i<aSingleOrganization.currencies.count && i<3; i++)   {
...
//      
//      
//      currencyKeyTitle.translatesAutoresizingMaskIntoConstraints = NO;
//      currencyValue.translatesAutoresizingMaskIntoConstraints = NO;
//      [contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-25-[currencyKeyTitle][currencyValue]-25-|" options:0 metrics:nil views:@{ @"currencyKeyTitle" : currencyKeyTitle, @"currencyValue" : currencyValue}]];
//      NSInteger vSpace = CGRectGetHeight(contentView.frame)*(0.3 + i*0.1);
//      [currencyKeyTitle addConstraint:[NSLayoutConstraint constraintWithItem:currencyKeyTitle attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.0f constant:20]];
//      
//      [currencyValue addConstraint:[NSLayoutConstraint constraintWithItem:currencyValue attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.0f constant:20]];
//      
//      [contentView addConstraint:[NSLayoutConstraint constraintWithItem:currencyKeyTitle attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:contentView attribute:NSLayoutAttributeTop multiplier:1.0f constant:vSpace]];
//      
//      [contentView addConstraint:[NSLayoutConstraint constraintWithItem:currencyValue attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:contentView attribute:NSLayoutAttributeTop multiplier:1.0f constant:vSpace]];
//    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
  ...
  if (!cell)
  {
    ...
    create =@"created";//  NSLog(@"Cell %li is created",indexPath.row);
  }
  else
  {
    create =@"reused"; // NSLog(@"Cell %li is reused",indexPath.row);
  }
